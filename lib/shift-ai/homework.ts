...
export function buildHomeworkVisionPrompt(
  ...
  return withLanguageInstruction(
    `This is a student's homework. Help them understand and solve it step by step. Do not just give the final answer — guide them through the reasoning, appropriate for a ${yearGroup} student. If you cannot read the image clearly, say so.
