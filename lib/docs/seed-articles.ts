/**
 * Source content for doc_articles seed rows.
 * Applied via supabase/docs-hub-migration.sql — keep in sync when editing articles.
 */
export const SEED_DOC_ARTICLES = [
  {
    slug: 'welcome-to-niskbuild',
    title: 'Welcome to NiskBuild',
    category: 'Getting Started',
    plan_visibility: ['all'],
    order_index: 10,
    content: `# Welcome to NiskBuild
...
`,
  ...
  {
    slug: 'submitting-to-app-store',
    title: 'Submitting Your App to the App Store',
    category: 'Exporting to App Store',
    plan_visibility: ['agency', 'scale', 'white_label', 'team_enterprise', 'sovereign'],
    order_index: 20,
    content: `# Submitting Your App to the App Store
...
`,
  ...
  {
    slug: 'importing-from-base44',
    title: 'Importing an App from Base44',
    category: 'Importing Apps',
    plan_visibility: ['all'],
    order_index: 30,
    content: `# Importing an App from Base44
...
`,
  ...
  {
    slug: 'getting-started-free',
    title: 'Getting Started on Sandbox (Free)',
    category: 'Your Plan',
    plan_visibility: ['free'],
    order_index: 100,
    content: `# Getting Started on Sandbox
...
`,
  ...
  {
    slug: 'getting-started-pro',
    title: 'Getting Started on Pro Worker',
    category: 'Your Plan',
    plan_visibility: ['pro', 'basic'],
    order_index: 101,
    content: `# Getting Started on Pro Worker
...
`,
  ...
  {
    slug: 'getting-started-agency',
    title: 'Getting Started on Agency Studio',
    category: 'Your Plan',
    plan_visibility: ['agency'],
    order_index: 102,
    content: `# Getting Started on Agency Studio
...
`,
  ...
  {
    slug: 'getting-started-scale',
    title: 'Getting Started on Scale Team',
    category: 'Your Plan',
    plan_visibility: ['scale'],
    order_index: 103,
    content: `# Getting Started on Scale Team
...
`,
  ...
  {
    slug: 'getting-started-white-label',
    title: 'Getting Started on White-Label',
    category: 'Your Plan',
    plan_visibility: ['white_label'],
    order_index: 104,
    content: `# Getting Started on White-Label
...
`,
  ...
  {
    slug: 'getting-started-team-enterprise',
    title: 'Getting Started on Team Enterprise',
    category: 'Your Plan',
    plan_visibility: ['team_enterprise'],
    order_index: 105,
    content: `# Getting Started on Team Enterprise
...
`,
  ...
  {
    slug: 'getting-started-sovereign',
    title: 'Getting Started on Sovereign',
    category: 'Your Plan',
    plan_visibility: ['sovereign'],
    order_index: 106,
    content: `# Getting Started on Sovereign
...
`,
  ...
  {
    slug: 'what-is-niskbuild',
    title: 'What is NiskBuild?',
    category: 'Getting Started',
    plan_visibility: ['all'],
    order_index: 12,
    content: `# What is NiskBuild?
