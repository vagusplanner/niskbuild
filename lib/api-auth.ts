...
export const RATE_LIMITS: Record<string, number> = {
  ...
  '/api/vagus-planner/google-calendar/connect': 20,
  '/api/vagus-planner/google-calendar/callback': 30,
  '/api/vagus-planner/google-calendar/disconnect': 20,
  '/api/vagus-planner/google-calendar/status': 60,
