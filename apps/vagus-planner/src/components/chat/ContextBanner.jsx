...
const CONTEXT_CONFIG = {
  ...
  general: { icon: Users,    label: 'Family Group',         color: 'from-teal-50 to-emerald-50 dark:from-teal-950/30 dark:to-emerald-950/20', text: 'text-teal-700 dark:text-teal-300',  badge: 'bg-teal-100 dark:bg-teal-900/40 text-teal-600',  link: '/Islam' },
};
