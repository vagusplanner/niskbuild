...
export default function WeekView({ currentDate, events = [], onEventClick, weekStartsOn = 1, showFastingDays = false, eventColorMode = {} }) {
            ...
            <div key={day.toString()} className="p-2 border-r min-h-[60px] relative">
              {allDayEvents.map(event => (
                <button
                  ...
                  className="w-full p-1.5 rounded text-xs mb-1 text-left ring-1 ring-black/5"
