...
export default function RamadanChallenges() {
  ...
  const { data: challenges = [] } = useQuery({
    ...
    queryFn: () => base44.entities.RamadanChallenge.list()
  });

  const completeMutation = useMutation({
    mutationFn: (id) => base44.entities.RamadanChallenge.update(id, { completed: true, completed_date: new Date().toISOString() }),
    onSuccess: () => {
