  ...
  return (
    <div className="space-y-6">
      <div className="forge-block p-6">
        <h1 className="font-display text-3xl forge-copper-text">Connect</h1>
        <p className="text-forge-copper-cream/60 mt-2">Forged with iron discipline and copper warmth.</p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Connect Workspace</CardTitle>
          <CardDescription>Your connect tools live here.</CardDescription>
        </CardHeader>
        <CardContent>
