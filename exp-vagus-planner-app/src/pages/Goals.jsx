...
export default function Goals() {
  ...
  const { data: goals = [], isLoading } = useQuery({
    queryKey: ['lifeGoals'],
    queryFn: () => SDK.entities.LifeGoal.list('-created_date')
  });

  const createMutation = useMutation({
    mutationFn: (data) => SDK.entities.LifeGoal.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => SDK.entities.LifeGoal.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries(['lifeGoals']);
      setShowForm(false);
      setEditingGoal(null);
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => SDK.entities.LifeGoal.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries(['lifeGoals']);
