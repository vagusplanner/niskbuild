...
export default function PrayerReminderCustomizer() {
  ...
  const { data: settings = [] } = useQuery({
    ...
    queryFn: () => SDK.entities.PrayerReminderSettings.list(),
    initialData: []
  });

  const createSettingMutation = useMutation({
    mutationFn: (data) => SDK.entities.PrayerReminderSettings.create(data),
    onSuccess: () => {
  ...
  const updateSettingMutation = useMutation({
    mutationFn: ({ id, data }) => SDK.entities.PrayerReminderSettings.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['prayer-reminder-settings'] });
