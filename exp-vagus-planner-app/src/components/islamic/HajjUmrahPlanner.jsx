...
export default function HajjUmrahPlanner() {
  ...
  const generateItinerary = async () => {
    ...
    setGenerating(true);
    try {
      const { data } = await SDK.functions.invoke('hajjUmrahAIAssistant', {
      ...
      await SDK.entities.Holiday.create({
  ...
  const handleGeneratePersonalizedPlan = async (preferences) => {
    setGenerating(true);
    try {
      const { data } = await SDK.functions.invoke('generatePersonalizedPilgrimagePlan', preferences);
  ...
  const handleGetFeedback = async (feedbackData, callback) => {
    ...
    try {
      const { data } = await SDK.functions.invoke('analyzePilgrimagePlanFeedback', feedbackData);
