    ...
    <div className="min-h-screen bg-[#0B0F19] flex flex-col items-center justify-center px-6">
      ...
      <div className="max-w-md text-center">
        ...
        <p className="text-[#94A3B8] text-sm leading-relaxed mb-8">
          This deployment is suspended because the owner&apos;s subscription is inactive.
          Reactivate the plan to bring this app back online.
        </p>
        <a
          href={pricingUrl}
        ...
        >
          Reactivate {product === 'NiskBuild' ? 'NiskBuild' : 'plan'}
        </a>
      </div>
    </div>
  );
