...
export default function ChatSidebar({ 
  ...
  const handleSaveContactDetails = async () => {
    ...
    try {
      await base44.entities.SocialConnection.update(editingContact.id, { notes: contactNotes });
  ...
  const handleUpdateRelationship = async (contactId, relationship) => {
    try {
      await base44.entities.SocialConnection.update(contactId, { relationship });
