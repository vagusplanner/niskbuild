...
function ExerciseForm({ date, existingData, onSuccess, onCancel }) {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      if (existingData) {
        return await base44.entities.Exercise.update(existingData.id, data);
      }
      return await base44.entities.Exercise.create({ ...data, date });
    },
    onSuccess
  });
...
function NutritionForm({ date, existingData, onSuccess, onCancel }) {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      if (existingData) {
        return await base44.entities.Nutrition.update(existingData.id, data);
      }
      return await base44.entities.Nutrition.create({ ...data, date });
    },
    onSuccess
  });
...
function MoodForm({ date, existingData, onSuccess, onCancel }) {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      if (existingData) {
        return await base44.entities.Mood.update(existingData.id, data);
      }
      return await base44.entities.Mood.create({ ...data, date });
    },
    onSuccess
  });
...
function SleepForm({ date, existingData, onSuccess, onCancel }) {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      if (existingData) {
        return await base44.entities.Sleep.update(existingData.id, data);
      }
      return await base44.entities.Sleep.create({ ...data, date });
    },
    onSuccess
  });
