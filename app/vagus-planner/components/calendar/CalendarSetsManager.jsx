...
export default function CalendarSetsManager({ onSetChange }) {
  ...
  const { data: sets = [] } = useQuery({
    ...
    queryFn: () => base44.entities.CalendarSet.list()
  });

  const createMutation = useMutation({
    mutationFn: (data) => base44.entities.CalendarSet.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => base44.entities.CalendarSet.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries(['calendarSets']);
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => base44.entities.CalendarSet.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries(['calendarSets']);
