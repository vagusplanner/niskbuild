...
export default function AdminSubscriptionsPage() {
  ...
  const generateReportMutation = useMutation({
    mutationFn: async (period) => {
      const { data } = await base44.functions.invoke('generateSubscriptionReports', {
  ...
  const retryPaymentMutation = useMutation({
    mutationFn: async (subscriptionId) => {
      await base44.functions.invoke('automatedBillingHandler', {
  ...
  const updatePlanMutation = useMutation({
    mutationFn: async ({ subId, userEmail, fromPlan, toPlan }) => {
      await base44.entities.Subscription.update(subId, { plan: toPlan });
      await base44.functions.invoke('sendBillingEmail', {
