...
/**
 * NiskBuild platform Terms of Service (existing content).
 */
export default function NiskBuildTermsPage() {
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p>
              By accessing or using NiskBuild (&quot;the Service&quot;), you agree to be bound by
          ...
          <section>
            ...
            <p>
              NiskBuild is an AI-powered app builder that generates code based on user prompts. Users
              can generate applications locally or via cloud AI, save projects, export code as ZIP,
              and deploy to various platforms.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Team Enterprise ($1,999/month): Mid companies —{' '}
              ...
              <li>
                Sovereign ($3,999/month + $1,500 setup): Enterprise —{' '}
                <Link href="/pricing" className="text-purple-400 hover:text-purple-300">
                  self-serve checkout
                </Link>{' '}
                with one-time setup fee
              </li>
          ...
          <section>
            ...
            <p>
              <strong>You own all code you generate using NiskBuild.</strong> When you export your
              project as ZIP, you receive full ownership of the generated code. No watermarks, no
              lock-in, no hidden fees. We claim no intellectual property rights over your generated
              applications.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AI-generated code is provided &quot;as-is&quot; without warranties of correctness or
              completeness. You are responsible for reviewing, testing, and modifying generated code
              before production use. NiskBuild uses Groq and Together AI for cloud generation, with
              local Ollama fallback for privacy-conscious users.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Your projects will remain accessible but you cannot generate new code without an
                active subscription
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              NiskBuild is not liable for any indirect, incidental, or consequential damages arising
              from your use of the Service. Our total liability is limited to the amount you paid us
